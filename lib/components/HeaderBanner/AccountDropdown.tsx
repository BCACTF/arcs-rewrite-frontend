...
export const DropdownEntry: FC<DropdownEntryProps> = ({ href, entryText }) => (
    <Link href={href} className="flex items-center justify-center w-full h-8 hover:bg-opacity-10 sm:hover:bg-navbar-account-dropdown-hover-color group max-sm:text-navbar-text-color-normal sm:text-navbar-account-dropdown-text-color">
    ...
    return (
        <div className="sm:my-auto">
            ...
            <div className={` max-sm:hidden
                ...
                w-40 md:w-52 lg:w-60 h-9 py-2 relative
                rounded-t-2xl  transition-all duration-200
                overflow-ellipsis
                ...
                <span className=" mr-2 ml-4 overflow-ellipsis overflow-clip text-navbar-account-dropdown-text-color z-10 w-3/4 text-center">
                    {name}
                </span>
                <div className={`
