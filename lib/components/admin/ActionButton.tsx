...
const ActionButton = ({
    confirmed, action, actionName,
    setModalAction,
    children, className,
}: {
    confirmed: boolean, action: () => Promise<unknown>, actionName: string,
    ...
    const clickCallback = useCallback(() => confirmed ? setModalAction([actionThenRefresh, actionName]) : actionThenRefresh(), [confirmed, actionThenRefresh]);
