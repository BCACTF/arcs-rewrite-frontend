    ...
    return (
        <div className="flex flex-col h-screen">
            ...
            <div className="flex flex-col sm:px-16">
                ...
                <p className="mx-16">The Bergen County Academies CTF Club is a group of CTF enthusiasts at the Bergen County Academies high school. We created BCACTF 3.0 to share our love of CTFs with high schoolers everywhere. {metadata.name}'s student contributors are, in alphabetical order by last name:</p>
                ...
                <p className="mx-16">Join our <Link className="underline text-about-link-color hover:text-about-link-hover-color transition" href="https://bcactf.com/discord">Discord server</Link> to find a team or have a chat.</p>
